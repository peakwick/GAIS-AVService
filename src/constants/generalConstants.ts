...
export const DEFAULT_GENERAL_SETTINGS: GeneralSettings = {
  ...
  currency: 'TRY',
  defaultCustomConditions: '- Çalışma saatleri hafta içi 09:00 - 18:00 arasındadır.\n- Sözleşmede tanımlanan ziyaret sayısı veya çalışma saatleri dışındaki talepler, o günkü "Adam/Saat" bedeli üzerinden ayrıca ücretlendirilir.\n- Sözleşme bedeli Türk Lirası (TL) ve KDV hariç olarak belirlenmiştir ve sözleşme süresi boyunca sabittir.\n- Sözleşme kapsamına yedek parça, tamirat, tamirat giderleri ve sarf malzemeleri dahil değildir.\n- Sözleşme, imza tarihinden itibaren 1 (bir) yıl süreyle geçerlidir. Sözleşme süresi sonunda herhangi bir bildirim gerekmeksizin kendiliğinden sona erer.\n- Donanım arızası tespit edildiğinde, onarım işlemi (eğer mümkünse) cihazın kendi garantisi veya Müşteri tarafından ayrıca satın alınan üretici servis paketleri (Örn: Zebra OneCare) üzerinden yürütülür. Ricoh, bu süreçte sadece arıza tespiti ve lojistik koordinasyon desteği verir.\n- Tüm hizmet bedelleri, seçilen periyodun (Yıllık, Çeyreklik veya Aylık) başında peşin olarak tahsil edilmektedir.\n- Hizmetin müşteri tarafından süresinden önce sonlandırılması durumunda, hali hazırda tahsil edilmiş olan dönem ödemelerinin iadesi yapılmamaktadır.',
};
